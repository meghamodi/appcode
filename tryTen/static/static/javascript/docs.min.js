...
function AnchorJS(a) {
    ...
    this.options = a || {}, this.elements = [], b(this.options), this.isTouchDevice = function() {
        ...
        var e,
            ...
            p,
            q = [];
        if (b(this.options), p = this.options.visible, "touch" === p && (p = this.isTouchDevice() ? "always" : "hover"), a || (a = "h1, h2, h3, h4, h5, h6"), e = c(a), 0 === e.length)
            return !1;
        for (d(), f = document.querySelectorAll("[id]"), g = [].map.call(f, function(a) {
            ...
            if (this.hasAnchorJSLink(e[i]))
                ...
                if (e[i].hasAttribute("id"))
                    h = e[i].getAttribute("id");
                else {
                    l = this.urlify(e[i].textContent), m = l, k = 0;
                    do void 0 !== j && (m = l + "-" + k), j = g.indexOf(m), k += 1;
                    while (-1 !== j);
        ...
        for (var b, d, e = c(a), f = 0; f < e.length; f++)
            d = e[f].querySelector(".anchorjs-link"), d && (b = this.elements.indexOf(e[f]), -1 !== b && this.elements.splice(b, 1), e[f].removeChild(d));
        return this
...
!function(a) {
    ...
    var T = function(a, g) {
        ...
        case "load":
            if (h) {
                if (!c(h))
                    return void T.call(this, "onWrongFlash", {
                        flashVersion: h
                    });
